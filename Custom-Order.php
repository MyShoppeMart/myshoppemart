...
<body>
    ...
    <div id="slider2">
<figure>
<a href="Custom-Order.html">
    <img src="Images/CUSTOM ORDER.jpg" alt >
</a>
<a href="#">
    <img src="Images/SHOPPEMART NEW DESIGNS.jpg" alt>
</a>
<a href="#">
    <img src="Images/SHOPPEMART-DESIGNS.gif" alt>
</a>
<a href="#">
        ...
        <form action="connect.php" method="post" class="col-md-8">
            <div class="column">
                ...
                <div class="col-xs-6 col-sm-3">
                    <button class="btn btn-success-primary" type="reset" style="background-color: #FFEB3B;">Clear Fields</button>
                </div>
            </div>
        </form>
    </div>
...
<script src="js/jquery.min.js"></script>
    ...
    <!--javascript for handling button checks---->
