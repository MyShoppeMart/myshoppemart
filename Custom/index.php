...
<head>
    ...
    <script type="text/javascript">!function(t,e){"use strict";var r=function(t){try{var r=e.head||e.getElementsByTagName("head")[0],a=e.createElement("script");a.setAttribute("type","text/javascript"),a.setAttribute("src",t),r.appendChild(a)}catch(t){}};t.CollectId = "5a32f36b6fddc44df54b8b2e",r("https://s3.amazonaws.com/collectchat/launcher.js")}(window,document);</script>
    
</head>
<body>
    <div class="newnav">
        <div>
        <a href="http://myshoppemart.com/" id="thelogo"><img src="Images/christmaspng.png" width="80" height="80"></a>
        </div>
        <label for="toggle" id="mainLabel"><i class="fa fa-bars" aria-hidden="true"></i></label>
        <input type="checkbox" id="toggle"/>
        <div class="menu">
            <a href="index.html"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
            <a href="http://myshoppemart.com/Platforms.html"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Platforms</a>
            <a href="http://myshoppemart.com/Contact-Us.html"><i class="fa fa-address-card-o" aria-hidden="true"></i> Contact</a>
            <a href="http://myshoppemart.com/About-Us.html"><i class="fa fa-info-circle" aria-hidden="true"></i> About</a>
        </div>

    </div>
    
</div>
    <div id="templatemo_describe" class="container_wapper">
    <div class="container-fluid">
        ...
        <form action="connect.php" method="post" class="col-md-8">
            <div class="column">
                ...
                <h2>I want to buy:</h2>
                <p>Couldn't find exactly what you want? No problems, we've got you covered just describe your product(s) and place an order, we'll contact you with the details and price(s) if found, for confirmation and further processing.</p>
                </div>
